...
<body>
    <header>
        ...
        <a class="nav-links mx-3  fs-5" aria-current="page" href="donkeyairpage.php">Donkey Air.</a>
            ...
            <div class=" collapse navbar-collapse justify-content-end ul-bg" id="btn">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link mx-3  fs-5" aria-current="page" href="/index">Recherche Vol</a>
                    </li>
                    <li class="nav-item">
